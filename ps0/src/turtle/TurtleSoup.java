...
public class TurtleSoup {
    ...
    public static void drawRegularPolygon(Turtle turtle, int sides, int sideLength) {
        double degrees = (double) 180 - calculateRegularPolygonAngle(sides);
    ...
    public static List<Double> calculateHeadings(List<Integer> xCoords, List<Integer> yCoords) {
        ...
        for (int i = 0; i < noOfCoords - 1; i++) {
            headingAngles.add(calculateHeadingToPoint(currentHeading, xCoords.get(i), yCoords.get(i), 
    ...
    public static void main(String args[]) {
        ...
        drawRegularPolygon(turtle, 5, 25);
